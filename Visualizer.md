...
5. This is where temporary items that have been used previously and are currently in effect are displayed.
6. This is the turn counter.
7. Drag along this timeline to look at a different point in time.


**Bot Animations Explained:**
